...
constexpr static float init_dec_year_f = init_dec_year;
 ...
 *  version). */
constexpr static float earth_rate_ecef_z_f = earth_rate_ecef_z;
 ...
 *  version). */
constexpr static lin::Vector3f earth_precession_rate_f = earth_precession_rate;
...
constexpr static lin::Vector4f q_ecef0_eci_f(q_ecef0_eci);

/** Eccentricity of Earth's orbit. */
constexpr static double earth_eccentricity = 0.0167086L;

/** Eccentricity of Earth's orbit (float version). */
constexpr static float earth_eccentricity_f = earth_eccentricity;
...
constexpr static float earth_perihelion_time_f = earth_perihelion_time;
...
constexpr static float earth_period_f = earth_period;
 ...
 *  version). */
constexpr static lin::Vector4f q_eci_perifocal_f(q_eci_perifocal);
...
constexpr static float b_noise_floor_f = b_noise_floor;
...
constexpr static float max_mtr_moment_f = max_mtr_moment;
