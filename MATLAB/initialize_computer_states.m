...
computer_state_follower.initialization_hold_done=false;
computer_state_follower.mag_bias_est_state= initialize_mag_bias_est();
computer_state_follower.detumbler_state=initialize_detumbler_state();
...
computer_state_leader.initialization_hold_done=false;
computer_state_leader.mag_bias_est_state= initialize_mag_bias_est();
computer_state_leader.detumbler_state=initialize_detumbler_state();
