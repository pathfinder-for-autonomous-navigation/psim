...
% generate mex code
try mex CXXFLAGS='$CXXFLAGS -std=c++14' ../environmental_models/helper_functions/geomag_wrapper.cpp -R2018a -silent; catch; end
try mex CXXFLAGS='$CXXFLAGS -std=c++14' ../environmental_models/helper_functions/geograv_wrapper.cpp -R2018a -silent; catch; end
