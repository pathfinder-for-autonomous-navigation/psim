function [XYZ, H, DEC, DIP, F] = wrldmagm_noerror(height, lat, lon, dyear, varargin )
...
%   Magnetic Model (WMM).  The default WMM is WMM-2015 which is valid from
%   January 1, 2015 until December 31, 2019.
%
...
%
%   [XYZ, H, DEC, DIP, F] = WRLDMAGM(HEIGHT, LAT, LON, DYEAR, '2015' ) is an 
%   alternate method for calling WMM-2015 or 2015 epoch.
%
%   Limitations:
%
...
if ((nargin < 5) && ( dt < 0.0 && dt >= -5.0 ))
    error(message('aero:wrldmagm:updateEpoch',2015));
end
