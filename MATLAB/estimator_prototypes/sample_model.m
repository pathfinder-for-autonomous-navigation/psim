...
%       state
%   state= updater(state,t0,dt) is a function that takes in the state as a column vec at time t0
%       and outputs the new state at time t0+dt
%   measure= measurer(state,t) is a funtion that makes a mesurement of the state at
%       time t
%   dt is the time step
