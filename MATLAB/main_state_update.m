...
main_state.follower.sensors= sensors_update(main_state.follower,main_state.leader);
main_state.leader.sensors= sensors_update(main_state.leader,main_state.follower);
