...
static void test_update() {
  ...
  TEST_ASSERT_TRUE(state.is_valid);
  TEST_ASSERT_LIN_FRO_NEAR_REL(1.0e-2f, q_out, estimate.q_body_eci);
  //TEST_ASSERT_LIN_FRO_NEAR_REL(1.0e-1f, gyr_bias_out, estimate.gyro_bias); // This specifically is suspicious
  //TEST_ASSERT_LIN_FRO_NEAR_REL(1.0e-2f, P_out, estimate.P);                // yz componenets are too large
}
